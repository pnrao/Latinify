...
var indicTable = (function() {
    const sources = [
        devanagariTable, bengaliTable, gurmukhiTable, gujaratiTable, odiaTable,
        tamilTable, teluguTable, kannadaTable, malayalamTable, sinhalaTable,
    ];
    const t = new Array(0x500).fill(null);
    sources.forEach((src, i) => {
        src.forEach((entry, j) => { if (entry !== null) t[i * 0x80 + j] = entry; });
    });
    return t;
})();
